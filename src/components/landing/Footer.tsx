      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-xl">
          ...
          <p className="text-gray-400">
            Empowering gospel artists, pastors, and content creators to share
            their message with the world. Join our growing community of
            believers and make your voice heard.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="md:col-span-2">
            {/* Social Links */}
            <h4 className="text-gold-900 font-semibold mb-4">
              Connect With Us
            </h4>

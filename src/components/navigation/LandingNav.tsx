        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link to="/login">
              <Button
                variant="ghost"
                className="text-gray-300 hover:text-gold-900"
              >
                Sign In
              </Button>
            </Link>

            <Button className="bg-gold-900 hover:bg-gold-900/90 text-white">
              Get Started
            </Button>
          </div>
            ...
            >
              <div className="py-4 space-y-4">
                ...
                <div className="pt-4 space-y-4">
                  <Button
                    variant="ghost"
                    className="w-full text-gray-300 hover:text-gold-900"
                  >
                    Sign In
                  </Button>
